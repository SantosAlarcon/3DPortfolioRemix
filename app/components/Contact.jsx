    ...
    return (
        <div className="flex flex-col-reverse gap-10 overflow-hidden text-[18px] xl:mt-12 xl:flex-row">
            ...
            >
                ...
                <div className="flex md:flex-col justify-between gap-8 py-8">
                    <a
                        href="/CurriculumFullStack.pdf"
                        className="flex w-fit md:w-full items-center gap-2 rounded-xl bg-tertiary px-8 py-3 font-bold text-white shadow-md shadow-primary outline-none active:scale-95 active:shadow-inner"
			title="Descargar CV"
                    >
                        <svg
                    ...
                    <a
                        href="tel:641278743"
                        className="flex w-fit md:w-full items-center justify-center gap-2 rounded-xl bg-tertiary px-8 py-3 font-bold text-white shadow-md shadow-primary outline-none active:scale-95 active:shadow-inner"
