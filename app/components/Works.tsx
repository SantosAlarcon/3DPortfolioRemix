		...
		>
			...
			<div className="mt-4 flex flex-wrap gap-2">
				{tags.map((tag: Tag) => (
					<p
						key={tag.name}
						className={`rounded-md px-2 py-[0.15em] text-[14px] ${tag.color} font-bold`}
					>
						{tag.name}
					</p>
				))}
		...
		<>
			...
			<div className="flex w-full">
				...
				>
					...
					<br />
					<br />
					Pulsa en el icono de <b>GitHub</b> para ir al repositorio, o el icono
					del <b>globo</b> para ver el proyecto en funcionamiento.
				</MotionP>
			</div>
