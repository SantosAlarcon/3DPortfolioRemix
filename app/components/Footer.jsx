	...
	return (
		<footer className="mx-auto flex flex-col justify-center gap-5 bg-black-100 px-6 py-8 text-[18px] max-sm:text-[14px]">
			<div className="z-40 flex items-center justify-center gap-5">
				<a href="mailto:santosalarcon86@gmail.com" aria-label="Correo electrónico" title="Correo electrónico">
					<svg
				...
				<a href="https://github.com/SantosAlarcon" target="_blank" aria-label="GitHub" title="Perfil de GitHub">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						id="social"
						xmlnsXlink="http://www.w3.org/1999/xlink"
			...
			<p className="text-center">
				@ {new Date().getFullYear()} <b>Santos Alarcón Asensio</b> - Todos los derechos reservados.
				<br />
