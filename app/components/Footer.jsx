	...
	return (
		<footer className="mx-auto flex max-sm:flex-col-reverse justify-center gap-5 bg-black-100 px-12 py-5 text-[18px] max-sm:text-[14px]">
			<p className="max-sm:text-center w-full">
				...
				derechos reservados.
				Hecho desde <b>La Mancha</b> y con el ❤ al mundo.
			</p>
				...
				>
					...
					>
						...
						>
							...
							>
								<g id="icons" transform="translate(56.000000, 160.000000)" fill="currentColor">
									<path
					...
					>
						<g clip-path="url(#clip0_5_2)">
							...
							<path
								...
								fill="currentColor"
							/>
							<path d="M33.5986 0H0V4.53765H33.5986V0Z" fill="currentColor" />
						</g>
						<defs>
							<clipPath id="clip0_5_2">
								<rect width="34" height="38" fill="currentColor" />
							</clipPath>
						</defs>
					</svg>
				</a>
